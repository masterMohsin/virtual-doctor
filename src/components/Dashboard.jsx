  ...
  return (
    <div className="w-full  flex flex-col  md:flex-row min-h-screen md:w-full ">
      ...
      <div className="flex-1 mt-34  md:mt-0 z-10   md:p-6 overflow-hidden">
        ...
        <div className="cards w-full flex justify-evenly md:items-center">
          {/**appiontment card */}
          ...
          <div className="line-cards ">
            <div className="medicin-card rounded-2xl px-4 text-white bg-[#F2B544] w-44 md:w-[20rem] h-32">
              ...
              <div className=" mt-2  md:mt-0">
                <h2 className="font-bold text-xl md:text-2xl">My Medicine</h2>
            ...
            <div className="appiontment-card rounded-2xl text-white px-4 bg-red-500 md:w-[20rem] w-44  h-32">
              ...
              <div className=" mt-2 ">
                <h2 className="font-bold text-xl md:text-2xl">My appiontment</h2>
                <p className="text-lg mt-2">History</p>
              </div>
          ...
          {/** profile card */}
          <div className="profile -z-10 w-full md:w-[12rem]  absolute rounded-b-2xl md:rounded-2xl top-0 h-42 md:h-60 md:top-4 bg-[#0EBE7F] md:relative flex justify-evenly items-center text-white ">
      ...
      <div className="flex justify-between items-center mb-3">
        <h3 className="font-semibold text-lg">Popular Doctor</h3>
        <button
