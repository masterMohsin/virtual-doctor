      ...
      <div className="relative z-10 w-full max-w-xl px-6">
        <div className="p-8 md:p-12 text-center bg-white/20 backdrop-blur-md rounded-xl border border-white/30 shadow-lg">
          ...
          <button
            ...
            className="w-full max-w-xs bg-[#0EBE7F] text-white text-2xl py-3 cursor-pointer rounded-lg font-medium hover:bg-green-700 transition mb-4"
          ...
          <button
            ...
            className="w-full max-w-xs bg-[#0EBE7F] text-white py-3 cursor-pointer rounded-lg text-2xl font-medium hover:bg-green-700 transition"
